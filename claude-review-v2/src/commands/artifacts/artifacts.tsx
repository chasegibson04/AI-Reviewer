...
export const call: LocalJSXCommandCall = async (onDone, _context, _args) => {
  ...
  lines.push('- `manuscript_comment_metadata.json`')
  lines.push('- `manuscript_suggested_changes_manifest.json`')
  lines.push('- `support_ingest_report.json`')
  lines.push('- `support_ingest_cache_index.json`')
  lines.push('- `citation_verification_ledger.json`')
  lines.push('- `claim_verification_summary.json`')
