...
- claim: KEYWORDS: _large language model, high-throughput experimentation, ChatGPT, reaction optimization, literature mining_ ## ■ **[INTRODUCTION]** Chemical synthesis is a primary bottleneck in drug development.
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.1395), science.1259203.pdf (0.1136), ultrahigh-throughput-experimentation-for-information-rich-chemical-synthesis.pdf (0.1136)
...
- linked_references: 2
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.1633), science.1259203.pdf (0.14), d1sc06932b.pdf (0.0962)
...
- linked_references: 4
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.1429)
...
- priority: high
- status: cited_support_plausible
- claim: ## ■ **[EXPERIMENTAL][SECTION]** To test the effectiveness of reaction arrays designed by ChatGPT, a workflow to automatically generate reagent proposals and execute reaction arrays for popular reactions was developed.
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.1667)
...
- priority: high
- status: likely_overstated
- claim: A typical workflow can be summarized in three steps (Figure 1): - First, we should have ChatGPT generate reaction array designs for specific substrates based on simple text prompts.
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.186)
...
- claim: - Then, we should translate the output from ChatGPT into an input file for the HTE management software Figure 1.
...
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.1795), science.aac6153.pdf (0.0952)
...
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.1053)
...
- priority: high
- status: citation_exists_but_support_not_verified
- claim: ## ■ **[RESULTS]** ChatGPT is a newly released general-purpose AI language model developed by OpenAI.[17] It serves as a conversational model where the user can ask a series of questions and receive text answers based on the context of the conversation.
- linked_references: 1
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.0833)
...
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.1316)
...
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.125), d1sc06932b.pdf (0.0976), Predicting_reaction_conditions_from_limited_data_through_active_transfer_learnin.pdf (0.0976)
...
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.125)
...
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.175)
...
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.1212)
...
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.1395)
...
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.093)
...
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.1081)
...
- priority: high
- status: internally_supported
- claim: Dev._ 2023, 27, 1510−1516 **Organic Process Research & Development** ** ** Figure 5.
...
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.0857)
...
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.0882)
...
- priority: high
- status: likely_overstated
- claim: We note that the model does not discuss the addition of a base, so we directly ask in the same conversation: The Suzuki coupling between 6 and 7 proved to be more challenging for ChatGPT, with slightly over half the plate failing to produce a hit (Figure 7).
- support_sources: designing-chemical-reaction-arrays-using-phactor-and-chatgpt.pdf (0.0816)
